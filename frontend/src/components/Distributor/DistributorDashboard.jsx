  ...
  return (
    <div className="p-6">
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-6">
        <StatsCard
          title="Total Distributor Earnings"
          value={totalDistributorEarnings}
          money
        />
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            {pendingBatches.map((b) => (
              <BatchCard
                ...
                onApprove={() =>
                  axios.put(
                    `${API}/batches/distributor/approve/${b.batchId}/${distributorId}`
                  ).then(fetchBatches)
                }
                onReject={() => {
                  ...
                  if (!reason) return;
                  axios.put(
                    `${API}/batches/distributor/reject/${b.batchId}/${distributorId}`,
                    { reason }
                  ).then(fetchBatches);
                }}
                onTrace={() => navigate(`/trace/${b.batchId}`)}
              />
            ))}
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  <button
                    onClick={() =>
                      updateStatus(order.orderId, "IN_WAREHOUSE")
                    }
